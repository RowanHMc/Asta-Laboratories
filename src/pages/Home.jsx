...
import { Activity, ArrowRight, BookOpen, Database, FlaskConical, HelpCircle } from "lucide-react";
        ...
        <div className="w-full flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[10px] text-slate-400 font-medium">Research Portal</p>
            </div>
          </div>

          <nav className="hidden md:flex items-center gap-6 text-xs font-medium text-slate-600">
            <a href="#features" className="hover:text-[#064e3b] transition-colors flex items-center gap-1.5">
              <Activity className="w-3.5 h-3.5" />
              <span>Features</span>
            </a>
            <a href="#documentation" className="hover:text-[#064e3b] transition-colors flex items-center gap-1.5">
              <BookOpen className="w-3.5 h-3.5" />
              <span>Documentation</span>
            </a>
            <a href="#support" className="hover:text-[#064e3b] transition-colors flex items-center gap-1.5">
      ...
      <main className="max-w-5xl mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm">
            ...
            <h3 className="font-bold text-slate-900 mb-2">Analytics and Reports</h3>
            <p className="text-xs text-slate-500 leading-relaxed">
              Generate experimental reports, output data visualizers, and export metrics seamlessly.
            </p>
          </div>
          <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm">
            <div className="w-10 h-10 rounded-lg bg-[#064e3b]/10 text-[#064e3b] flex items-center justify-center mb-4">
            ...
            <p className="text-xs text-slate-500 leading-relaxed">
              Role-based access to the portals designed for students and their technicians.
            </p>
          </div>
        </div>
      </main>
